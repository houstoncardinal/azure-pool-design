...
const RuckerFamilyProject = () => {
  const project = {
    id: 'rucker-family-project',
    title: 'Rucker Family Project',
    subtitle: 'Luxury Pool & Spa Retreat',
    description: 'A stunning pool and spa combination for the Rucker family, featuring premium materials and sophisticated design elements. This project creates a true backyard oasis.',
    location: 'Friendswood, TX',
    category: 'Luxury Pool & Spa',
...
export default RuckerFamilyProject; 