...
const TemsFamilyProject = () => {
  const project = {
    id: 'tems-family-project',
    title: 'Tems Family Project',
    subtitle: 'Modern Pool & Outdoor Living Space',
    description: 'A sophisticated pool design for the Tems family, featuring modern aesthetics and seamless integration with their outdoor living space. This project creates a perfect balance of style and functionality.',
    location: 'Houston, TX',
    category: 'Modern Pool Design',
    size: 'Approx. 19,000 Gallons',
    features: [
      'Modern Pool Design',
      'Outdoor Kitchen',
      'Custom Decking',
...
export default TemsFamilyProject; 