...
const PhillipsFamilyProject = () => {
  const project = {
    id: 'phillips-family-project',
    title: 'Phillips Family Project',
    subtitle: 'Modern Pool with Smart Features',
    description: 'A contemporary pool design for the Phillips family, featuring integrated smart technology and modern aesthetics. This project demonstrates our ability to combine functionality with style.',
...
export default PhillipsFamilyProject; 