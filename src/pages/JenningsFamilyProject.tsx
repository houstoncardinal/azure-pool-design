...
const JenningsFamilyProject = () => {
  const project = {
    id: 'jennings-family-project',
    title: 'Jennings Family Project',
    subtitle: 'Family-Friendly Pool Design',
    description: 'A perfect family pool design for the Jennings family, featuring a spacious layout, safety features, and fun elements for all ages. This project creates an ideal environment for family gatherings and recreation.',
    location: 'Pearland, TX',
    category: 'Family Pool Design',
    size: 'Approx. 17,000 Gallons',
    features: [
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-blue-600 rounded-xl shadow-xl p-6 sm:p-8 text-white text-center">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <Button 
                  variant="outline"
                  className="border-2 border-white text-blue-100 hover:bg-white/10 font-semibold py-3 px-6"
                >
...
export default JenningsFamilyProject; 