...
const RobinsonFamilyProject = () => {
  const project = {
    id: 'robinson-family-project',
    title: 'Robinson Family Project',
    subtitle: 'Contemporary Pool & Outdoor Living',
    description: 'A modern pool design for the Robinson family, featuring a seamless integration with their outdoor living space. This project combines functionality with contemporary style.',
    location: 'Houston, TX',
    category: 'Contemporary Pool Design',
...
export default RobinsonFamilyProject; 